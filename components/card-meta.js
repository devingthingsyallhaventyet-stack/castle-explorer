// Lazily fills a listing card's live star rating and (for Google photos) the
// required photo attribution, by fetching /public/listing-card/{slug} only when
// the card scrolls into view. The endpoint is edge-cached, so repeat views are free.
(function () {
  function fill(el) {
